...
double GameObject::GetTransparency() const
{
...
void GameObject::Render()
{
    if (m_imageNumber >= 0 && m_imageNumber < int(m_images.size()))
    {
        ...
        {
            Vector2D cameraPos = HtCamera::instance.GetCameraCentre();
            ...
            Vector2D parallaxPos = m_position + cameraPos * parallaxFactor;

            HtGraphics::instance.DrawAt(parallaxPos, m_images[m_imageNumber], m_scale, m_angle, m_transparency);
        }
    }
	else
	{
