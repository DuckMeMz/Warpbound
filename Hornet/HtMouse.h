...
public:
    ...
    //Left click is getting stuck down on application launch. 
    //Bit janky
    //2:22 - 14 Hours remaining don't blame me :(
    void FakeLeftClick();
    ...
    //Returns the X & Y of the mouse position as a vector2D
    Vector2D GetPointerPosition() const;
